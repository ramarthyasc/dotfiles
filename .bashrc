...
#Ignore Ctrl+D as closing the terminal
set -o ignoreeof

#Alias for live-server - sot that it won't give a std output
alias live-server='live-server > /dev/null 2>&1'
...
# Recording function
record() {
  gpu-screen-recorder -w screen -f 60 -a default_output -o "$HOME/Videos/$1"
}
